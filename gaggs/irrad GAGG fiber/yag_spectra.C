...
void attlen(Double_t xwl=550, Double_t dxwl=2.5, Double_t &len, Double_t &slen, Double_t x1=0, Double_t x2=10){
...
void transm(Double_t xwl=550, Double_t dxwl=2.5, Double_t &att, Double_t &satt, Double_t x1=0, Double_t x2=10){
  Double_t s0[2][5], s1[2][5], s2[2][5];
  memset(&s0[0][0],0,sizeof(s0));
  memset(&s1[0][0],0,sizeof(s1));
  memset(&s2[0][0],0,sizeof(s2));
...
void yag_spectra(Double_t c1=1, Double_t c2=1, Double_t wl0=503, Double_t dwl=2.5)
{
